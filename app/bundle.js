...
},{"./common":5,"./components":7,"./config":8}],3:[function(require,module,exports){
...
angular.module('common', []).factory('eventFactory', require('./event-factory')).factory('gestureFactory', require('./gesture-factory')).factory('scrollFactory', ['eventFactory', require('./scroll-factory')]);

},{"./event-factory":3,"./gesture-factory":4,"./scroll-factory":6}],6:[function(require,module,exports){
...
function scrollFactory(eventFactory) {
    ...
    function smoothScrollTo(target, duration, element) {
        if (typeof target !== 'number' && typeof target === 'string') {
            ...
            if (!targetEl) return console.error(target + ' is an invalid ID to scroll to');
